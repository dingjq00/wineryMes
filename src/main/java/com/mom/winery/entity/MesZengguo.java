...
@JmixEntity
@Table(name = "MES_ZENGTONG", indexes = {
        @Index(name = "IDX_MES_ZENGTONG_MES_AREA", columnList = "MES_AREA_ID"),
        @Index(name = "IDX_MES_ZENGTONG_JIAOCHI_UP", columnList = "JIAOCHI_UP_ID"),
        @Index(name = "IDX_MES_ZENGTONG_ZENGGUO_PHASE", columnList = "ZENGGUO_PHASE_ID"),
        @Index(name = "IDX_MES_ZENGTONG_RUNLIANG_DURATION_QUALIFIED", columnList = "RUNLIANG_DURATION_QUALIFIED_ID"),
        @Index(name = "IDX_MES_ZENGTONG_RUNLIANG_DUARATION_QUALIFIED_UP", columnList = "RUNLIANG_DUARATION_QUALIFIED_UP_ID")
})
@Entity
public class MesZengguo {
    @JmixGeneratedValue
    ...
    @InstanceName
    @Column(name = "ZENGGUO_NAME", length = 120)
    private String zengguoName;
    ...
    @JoinColumn(name = "RUNLIANG_DURATION_QUALIFIED_ID")
    @ManyToOne(fetch = FetchType.LAZY)
    ...
    private String runliangEndTimeUp;
    ...
    public String getRunliangEndTimeUp() {
        return runliangEndTimeUp;
    }

    public void setRunliangEndTimeUp(String runliangEndTimeUp) {
    ...
    public void setRunliangDurationQualifiedDown(MesWinccItemConfig runliangDurationQualified) {
        this.runliangDurationQualifiedDown = runliangDurationQualified;
    }
    ...
    public String getZengguoName() {
        return zengguoName;
    }

    public void setZengguoName(String zengguoName) {
        this.zengguoName = zengguoName;
    }
