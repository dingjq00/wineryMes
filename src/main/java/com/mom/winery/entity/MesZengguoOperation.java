...
@Comment("甑锅操作记录")
@JmixEntity
@Table(name = "MES_ZENGGUO_OPERATION", indexes = {
        @Index(name = "IDX_MES_ZENGTONG_OPERATION_JIAOCHI_UP", columnList = "JIAOCHI_UP_ID"),
        @Index(name = "IDX_MES_ZENGTONG_OPERATION_ZENGGUO_PHASE", columnList = "ZENGGUO_PHASE_ID"),
        @Index(name = "IDX_MES_ZENGGUO_OPERATION_MES_ZENGGUO", columnList = "MES_ZENGGUO_ID"),
        @Index(name = "IDX_MES_ZENGGUO_OPERATION_RUNLIANG_DURATION_QUALIFIED_DOWN", columnList = "RUNLIANG_DURATION_QUALIFIED_DOWN_ID"),
        @Index(name = "IDX_MES_ZENGGUO_OPERATION_RUNLIANG_DUARATION_QUALIFIED_UP", columnList = "RUNLIANG_DUARATION_QUALIFIED_UP_ID")
})
@Entity
public class MesZengguoOperation {
    @JmixGeneratedValue
