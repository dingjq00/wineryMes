...
@Comment("各甑执行汇总信息")
@JmixEntity
@Table(name = "MES_ZENGGUO_UNIT_PROCEDURE", indexes = {
        @Index(name = "IDX_MES_ZENGTONG_UNIT_PROCEDURE_JIAOCHI_UP", columnList = "JIAOCHI_UP_ID"),
        @Index(name = "IDX_MES_ZENGTONG_UNIT_PROCEDURE_ZENGGUO_PHASE", columnList = "ZENGGUO_PHASE_ID"),
        @Index(name = "IDX_MES_ZENGGUO_UNIT_PROCEDURE_MES_ZENGGUO", columnList = "MES_ZENGGUO_ID"),
        @Index(name = "IDX_MES_ZENGGUO_UNIT_PROCEDURE_RUNLIANG_DURATION_QUALIFIED_DOWN", columnList = "RUNLIANG_DURATION_QUALIFIED_DOWN_ID"),
        @Index(name = "IDX_MES_ZENGGUO_UNIT_PROCEDURE_RUNLIANG_DUARATION_QUALIFIED_UP", columnList = "RUNLIANG_DUARATION_QUALIFIED_UP_ID")
})
@Entity
public class MesZengguoUnitProcedure {
    @JmixGeneratedValue
